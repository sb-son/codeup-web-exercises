 ...
 */
function analyzeColor(color = prompt("What color do you want to analyze?".toLowerCase())) {
    if (color=="blue") {
...
switch (switchColor) {
    case "blue":
        console.log(switchColor + " is the color of the sky.");
        break;
    case "red":
        console.log("Strawberries are " + switchColor);
        break;
    case "cyan":
        console.log("I don't know anything about " + switchColor);
        break;
    default:
        console.log(switchColor + " is okay I guess");
}
/**
 * TODO:
 ...
 */
/*I already generated a random number for my function*/
