...
(function (){
     ...
     */
    let helloMessage = sayHello("Shawn")
    ...
    function calculateTip(totalCost, tipPercentage) {
        totalCost = parseFloat(prompt("What is the total cost?"));
        tipPercentage = parseFloat(prompt("What percent tip would you like to leave?"));
        let newTotal = totalCost * (tipPercentage/100);
     ...
     */
    alert("You should leave a $" + calculateTip() + " tip.");
